...
import 'package:display_metrics_linux/display_metrics_linux.dart';
...
class _MyAppState extends State<MyApp> {
  late final DisplayMetricsLinux _displayMetricsPlugin;
  Size? _resolution;
  ...
  void initState() {
    super.initState();
    _displayMetricsPlugin = DisplayMetricsLinux();
    _getResolution();
    _getSize();
  }
