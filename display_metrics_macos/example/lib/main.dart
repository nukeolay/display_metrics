...
import 'package:display_metrics_macos/display_metrics_macos.dart';
...
class _MyAppState extends State<MyApp> {
  late final DisplayMetricsMacos _displayMetricsPlugin;
  Size? _resolution;
  ...
  void initState() {
    super.initState();
    _displayMetricsPlugin = DisplayMetricsMacos();
    _getResolution();
    _getSize();
  }
