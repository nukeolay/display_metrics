...
import 'package:display_metrics_windows/display_metrics_windows.dart';
...
class _MyAppState extends State<MyApp> {
  late final DisplayMetricsWindows _displayMetricsPlugin;
  Size? _resolution;
  ...
  void initState() {
    super.initState();
    _displayMetricsPlugin = DisplayMetricsWindows();
    _getResolution();
    _getSize();
  }
